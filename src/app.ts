...
export default async function (fastify: FastifyInstance): Promise<void> {
    ...
    fastify.route({
        ...
        handler: async (request, reply) => {
          const data = request.body as { email: string; name?: string };
    ...
    fastify.route({
        ...
        handler: async (request, reply) => {
          const data = request.body as { title: string; content?: string; published?: boolean; authorId: number };
    ...
    fastify.route({
        ...
        handler: async (request, reply) => {
          const { id } = request.params as { id: number };
          const data = request.body as { title?: string; content?: string; published?: boolean };
    ...
    fastify.route({
        ...
        handler: async (request, reply) => {
          const data = request.body as { bio?: string; userId: number };
    ...
    fastify.route({
        ...
        handler: async (request, reply) => {
          const { id } = request.params as { id: number };
          const data = request.body as { bio?: string };
